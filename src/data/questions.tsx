...
export const Questions: Array<Question> = [
...

	{
		...
		options: [
			{ title: "Rozhodčí nařídí volný úder za druhý přestupek.", isRight: true },
			{
...

	{
		...
		options: [
			...
			{ title: "Branku neuzná a nařídí trestné střílení.", isRight: false },
			{ title: "Branku uzná po poradě s hlavním pořadatelem.", isRight: false }
		]
	},

	{
		...
		options: [
			...
			{ title: "Branku neuzná a udělí hráči dvouminutový trest.", isRight: false }
		]
	},

	{
		...
		options: [
			{ title: "Branku neuzná a udělí hráči pětiminutový trest.", isRight: true },
			{ title: "Branku uzná.", isRight: false },
			{ title: "Branku neuzná a udělí hráči dvouminutový trest.", isRight: false },
...

	{
		...
		options: [
			...
			{ title: "Poslednímu útočícímu hráči, který se dotkl míče.", isRight: false },
			{
...

	{
		...
		options: [
			...
			{ title: "Nařídí volný úder z velkého brankoviště.", isRight: false }
		]
	},
...

	{
		...
		options: [
			...
			{ title: "O nejbližší přestávce opustit střídačku.", isRight: false },
...

	{
		...
		options: [
			...
			{ title: "Vhazování na nejbližším bodě pro vhazování.", isRight: false }
		]
	},

	{
		...
		options: [
			...
			{ title: "Bude udělen dvouminutový trest za hru na zemi.", isRight: false },
			{ title: "Bude udělen dvouminutový trest za hru rukou.", isRight: false }
		]
	},

	{
		...
		options: [
			...
			{ title: "Slovně hráče upozorní a nechá hru pokračovat.", isRight: false },
...

	{
		...
		options: [
			...
			{ title: "Musí při rozehrání držet hůl oběma rukama", isRight: false },
			{
...

	{
		...
		options: [
			{ title: "V pořadí, v jakém uplynuly jejich tresty.", isRight: true },
			{ title: "V pořadí, které určí rozhodčí.", isRight: false },
			{
				title: "V pořadí, v jakém jim byly uloženy jejich tresty.",
				isRight: false
			},
			{ title: "V pořadí dle rozhodnutí stolku zapisovatelů.", isRight: false }
		]
	},

	{
		...
		options: [
			...
			{ title: "Ne, pakliže rozhodčí nerozhodnou jinak.", isRight: false }
		]
	},

	{
		...
		options: [
			...
			{ title: "Tři, pokud je jedním z nich osobní trest.", isRight: false }
		]
	},
...

	{
		...
		options: [
			{ title: "Bude hra pokračovat dle důvodu přerušení.", isRight: true },
			{
...

	{
		...
		options: [
			...
			{ title: "Je vymezeno taxativně v pravidlech florbalu.", isRight: false },
			{ title: "Není v pravidlech florbalu vůbec zmiňováno.", isRight: false },
			{
...

	{
		...
		options: [
			...
			{ title: "Pouze pokud byl vstřelen regulérní gól.", isRight: false },
			{
...

	{
		...
		options: [
			...
			{ title: "Minimálně 3m od míče, florbalka může být blíže.", isRight: false },
...

	{
		...
		options: [
			{ title: "Je podezření, že došlo k vážnému zranění hráče.", isRight: true },
			{ title: "Ke zranění hráče došlo na útočné polovině.", isRight: false },
...

	{
		...
		options: [
			{ title: "Bezprostředně po skončení brankové situace.", isRight: true },
			{
...

	{
		...
		options: [
			...
			{ title: "Vedou automaticky k nařízení trestného střílení.", isRight: false },
			{
...

	{
		...
		options: [
			...
			{ title: "Hráč z družstva, které obdrželo branku.", isRight: false }
		]
	},

	{
		...
		options: [
			...
			{ title: "Hráč z družstva, které hraje v oslabení.", isRight: false }
		]
	},
...

	{
		...
		options: [
			{ title: "Vhazování na nejbližším bodě pro vhazování.", isRight: true },
			{
...

	{
		...
		options: [
			...
			{ title: "Ve vzpřímeném postoji nejbližšího soupeře.", isRight: false },
			{
...

	{
		...
		options: [
			...
			{ title: "Nařídí proti družstvu tohoto hráče volný úder.", isRight: false },
			{
...

	{
		...
		options: [
			...
			{ title: "Bude potrestán vyloučením na 2 + 10 minut.", isRight: false },
			{
...

	{
		...
		options: [
			{ title: "Úmyslné posunutí soupeřovy brány hráčem v poli.", isRight: true },
			{ title: "Účast ve hře hráče v poli bez florbalky.", isRight: false },
			{
...

	{
		...
		options: [
			{ title: "Bude hráči udělen trest vyloučení na 2 minuty.", isRight: true },
			{
...

	{
		...
		options: [
			{ title: "Dresy skládající se z trika, trenýrek a štulpen.", isRight: true },
			{
			...
			{ title: "Potítko, čelenku a nejnovější trendy oblečení.", isRight: false }
		]
	},

	{
		...
		options: [
			...
			{ title: "Triko s dlouhým rukávem, trenýrky a štulpny.", isRight: false },
			{
				title: "Triko, trenýrky a štulpny odlišné barevné kombinace, než mají družstva.",
				isRight: false
			},
			{ title: "Triko a trenýrky stejné barevné kombinace.", isRight: false }
		]
	},

	{
		...
		options: [
			...
			{ title: "Musí být potrestán osobním trestem 2+10 min.", isRight: false }
		]
	},
...

	{
		...
		options: [
			...
			{ title: "Obličejovou masku, trenýrky, triko a stulpny.", isRight: false },
			{
...

	{
		...
		options: [
			{ title: "Jakékoliv, které není určeno k chytání střel.", isRight: true },
			{
...

	{
		...
		options: [
			{ title: "Osobní vybavení, které může způsobit zranění.", isRight: true },
			{ title: "Čelenku bez uzlů.", isRight: false },
			{ title: "Ortopedické pomůcky všech druhů a velikostí.", isRight: false },
...

	{
		...
		options: [
			...
			{ title: "Píšťalkou, červenou kartou a pravidly florbalu.", isRight: false },
			{
...

	{
		...
		options: [
			...
			{ title: "Pouze kapitánem družstva nebo hlavním trenérem.", isRight: false },
...

	{
		...
		options: [
			...
			{ title: "Rozhodčí nechá zápas dohrát a zbylý čas odhadne.", isRight: false }
		]
	},
...

	{
		...
		options: [
			{ title: "Udělí hráči trest vyloučení na 2 minuty.", isRight: true },
			{
...

	{
		...
		options: [
			{ title: "Trest vyloučení na 2 minuty za špatné střídání.", isRight: true },
			{ title: "Trest ČK2 za sabotáž hry.", isRight: false },
			{ title: "Rozhodčí nechá pokračovat ve hře 5 na 5.", isRight: false },
			{ title: "Volný úder pro družstvo, které se neprovinilo.", isRight: false }
		]
	},
...

	{
		...
		options: [
			...
			{ title: "Celý trest si odsedí pouze vyloučený hráč.", isRight: false },
			{ title: "Kapitán.", isRight: false },
			{ title: "Rozhodčí si vybere podle svého uvážení.", isRight: false }
		]
	},
...

	{
		...
		options: [
			{ title: "Uzná branku.", isRight: true },
			{ title: "Neuzná branku a nařídí vhazování v rohu hřiště.", isRight: false },
			{
...

	{
		...
		options: [
			...
			{ title: "Vždy přesně z místa, kde k přestupku došlo.", isRight: false },
